"""Build standalone slide covering mid-level operational secondments
and locum coverage with rates and examples.

Companion to the senior secondments/fractional slides. Together the three
slides give a full picture: senior fractional, mid-level secondments, locum.
"""
...
# ============= TOP: Mid-level secondments table =============
top_y = Inches(2.2)
...
set_text(tf, "LOCUM CLINICAL COVER  /  PER SHIFT", size=11, bold=True, color=WHITE)

locum_roles = [
    ("Consultant Specialist", "N150K to N300K"),
    ("Medical Officer", "N50K to N100K"),
    ("ICU / Theatre Nurse", "N40K to N80K"),
    ("General Nurse", "N20K to N40K"),
    ("Pharmacist", "N40K to N80K"),
    ("Lab Scientist", "N30K to N60K"),
    ("Radiographer", "N50K to N100K"),
]
...
# Right side: How it works + examples
rx = Inches(8.5)
...
add_paragraph(tf, "≈ N1.8M to N3.2M / month, fully covered", size=11, bold=True, color=GOLD, space_before=Pt(4))
...
output_path = "/Users/debo/consult-for-africa/docs/cfa-midlevel-locum-slide.pptx"
