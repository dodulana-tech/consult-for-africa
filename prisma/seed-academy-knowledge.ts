...
Common MECE frameworks for hospital consulting include: Revenue vs. Cost decomposition, Internal vs. External factors, Clinical vs. Operational vs. Financial dimensions, and the Patient Journey framework (access, diagnosis, treatment, discharge, follow-up).`,
    ...
    },
    {
      ...
      content: `Issue trees are visual tools that decompose complex consulting problems into smaller, manageable components following the MECE principle. At CFA, issue trees are the primary diagnostic tool used in the first two weeks of every engagement.

Standard CFA Issue Tree Structures:
...
For CFA consultants, this means every client presentation, email, and deliverable follows the SCR format:
...
Every CFA slide should have an action title (a complete sentence stating the key message), not a topic title. "Revenue cycle has three critical gaps" not "Revenue Cycle Overview".`,
      assetType: 'GUIDE' as KnowledgeAssetType,
...
CFA uses this framework as the starting diagnostic for health systems advisory engagements, mapping each building block to specific assessment criteria and benchmarks relevant to the country context.`,
      assetType: 'GUIDE' as KnowledgeAssetType,
    ...
    },
    {
      ...
      content: `The DDDS (Diagnose, Design, Deliver, Sustain) framework is CFA's proprietary engagement methodology that structures every consulting engagement into four distinct phases. It ensures rigorous diagnosis before solutioning, structured implementation, and built-in sustainability.
...
CFA's Revenue Cycle Excellence programme typically identifies 20-35% revenue uplift potential in NHIS claims alone, primarily through improved charge capture, coding accuracy, and denial management.`,
      assetType: 'GUIDE' as KnowledgeAssetType,
...
Available as an interactive tool at /tools/issue-tree on the CFA Platform.`,
...
Available as an interactive tool at /tools/fishbone on the CFA Platform.`,
      assetType: 'TOOL' as KnowledgeAssetType,
...
Available as an interactive tool at /tools/raci-builder on the CFA Platform.`,
      assetType: 'TOOL' as KnowledgeAssetType,
...
When to use: Financial diagnostic phase of turnaround and operations engagements. Benchmark against CFA's African hospital financial database.`,
      assetType: 'TEMPLATE' as KnowledgeAssetType,
...
When to use: First deliverable in any hospital turnaround engagement. Updated weekly during the stabilization phase. Critical for identifying cash crunch points and prioritizing collection efforts.`,
    ...
    },
    {
      ...
      content: `CFA's proprietary hospital financial distress assessment tool. Scores hospitals on 12 indicators across four dimensions: Liquidity, Profitability, Operational Efficiency, and Governance.
...
Available as an interactive tool at /tools/bsc-builder on the CFA Platform.`,
      assetType: 'TEMPLATE' as KnowledgeAssetType,
...
Available as an interactive tool at /tools/fmea-worksheet on the CFA Platform.`,
      assetType: 'TOOL' as KnowledgeAssetType,
...
Available as an interactive tool at /tools/denial-dashboard on the CFA Platform.`,
      assetType: 'TOOL' as KnowledgeAssetType,
...
Available as an interactive tool at /tools/stakeholder-map on the CFA Platform.`,
      assetType: 'TOOL' as KnowledgeAssetType,
      tags: ['stakeholder', 'engagement', 'mapping', 'change-management'],
      isReusable: true,
    },
    {
      title: 'Logframe Template (CFA)',
      content: `Logical Framework (Logframe) template adapted for CFA's healthcare consulting engagements and development-funded programmes. Follows USAID/Global Fund standards.
...
Available as an interactive tool at /tools/logframe on the CFA Platform.`,
      assetType: 'TEMPLATE' as KnowledgeAssetType,
...
When to use: Lean healthcare engagements, process improvement projects, patient flow optimization.`,
    ...
    },
    {
      ...
      content: `Master template for structuring a CFA consulting engagement. Defines the overall engagement structure including governance, team composition, workstreams, milestones, and reporting cadence.
...
When to use: During the proposal/scoping phase and refined during the first week of engagement. This is the "constitution" of every CFA engagement.`,
      assetType: 'TEMPLATE' as KnowledgeAssetType,
    ...
    },
    {
      ...
      content: `CFA's standard consulting proposal template. Follows the Pyramid Principle structure with executive summary first, then detailed methodology, team, timeline, and commercial terms.
