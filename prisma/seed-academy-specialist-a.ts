/**
 * Consult For AfricaTRAINING ACADEMY - SPECIALIST LEVEL SEED A (Tracks 6-8)
...
async function main() {
  console.log('Seeding Consult For AfricaTraining Academy - Specialist Level Tracks (6-8)...\n')
  ...
  const hospitalTurnaround = await prisma.trainingTrack.create({
    data: {
      ...
      description: `Learn to diagnose failing hospitals and lead them back to financial and operational health.
        ...
        strategies tailored to African healthcare contexts, and the full Consult For Africa24-week Turnaround Programme
  ...
  const m6_1 = await prisma.trainingModule.create({
    data: {
        ...
        sections: [
          {
            ...
            body: `Hospital distress rarely arrives overnight. It follows a predictable pattern: declining occupancy, rising staff costs as a percentage of revenue, deferred maintenance creating a backlog, supplier relationships deteriorating as payment cycles stretch from 30 to 90 to 180 days. By the time leadership calls for help, the facility is typically 6 to 12 months away from insolvency. Your job as a turnaround consultant is to cut through the noise and identify where the hospital sits on the distress curve.
              ...
              The Consult For AfricaDistress Scorecard evaluates five dimensions: liquidity (can the hospital meet payroll next month?), operational performance (are beds, theatres, and clinics generating adequate throughput?), revenue integrity (is the hospital capturing and collecting what it earns?), cost structure (where is money leaking?), and leadership capacity (does the management team have the skill and will to execute change?). Scoring each dimension on a 1-5 scale gives you a rapid triage that determines whether the hospital needs stabilisation, restructuring, or managed wind-down.`
          },
          {
            title: 'The 10-Day Rapid Assessment',
            type: 'text',
            body: `Speed matters in turnaround work. A hospital burning cash cannot wait for a 12-week diagnostic. The Consult For AfricaRapid Assessment compresses a full diagnostic into 10 working days. Days 1-3 focus on financial triage: cash position, burn rate, creditor exposure, and revenue pipeline. You need to know how many weeks of runway remain before anything else matters.
        ...
        exercises: [
          {
            ...
            instruction: 'A 150-bed private hospital in Kampala has 45% bed occupancy, 72% staff cost ratio, 120-day average supplier payment cycle, and cash reserves covering 6 weeks of operations. Score each of the five Consult For AfricaDistress dimensions (1-5) and classify the overall severity.',
          },
          {
      ...
      resources: {
        links: [
          { title: 'Consult For AfricaDistress Scorecard Template', url: 'internal://knowledge/distress-scorecard' },
    ...
    data: [
      {
        ...
        question: 'In the Consult For AfricaDistress Scorecard, which dimension answers the question "Can the hospital meet payroll next month?"',
      ...
      },
      {
        moduleId: m6_1.id,
        type: 'MULTIPLE_CHOICE',
        question: 'During the Consult For Africa10-Day Rapid Assessment, what is the primary focus of Days 1-3?',
        options: JSON.stringify([
  ...
  await prisma.trainingQuestion.createMany({
    data: [
      ...
      },
      {
        moduleId: m6_2.id,
        type: 'MULTIPLE_CHOICE',
        question: 'In the Consult For Africa three-tier cost framework, which category should include frontline clinical staff and essential drugs?',
        options: JSON.stringify([
  ...
  // Module 6.3: Consult For AfricaTurnaround Programme
  const m6_3 = await prisma.trainingModule.create({
    data: {
      trackId: hospitalTurnaround.id,
      name: 'Consult For AfricaTurnaround Programme',
      slug: 'cfa-turnaround-programme',
      description: 'Master the Consult For Africa proprietary 24-week turnaround methodology that takes a distressed hospital from crisis to sustainable performance.',
      order: 3,
      estimatedMinutes: 120,
      passingScore: 80,
      content: {
        sections: [
          ...
          },
          {
            ...
            type: 'text',
            body: `Turnarounds fail without disciplined governance. Consult For Africa establishes a Turnaround Management Office (TMO) in the first week, co-led by the Consult For Africa engagement manager and a senior hospital executive. The TMO meets daily for the first four weeks (stabilisation), then three times weekly through restructuring, then weekly through rebuild and sustain phases. Every meeting follows a fixed agenda: cash position update, progress against the 30/60/90-day action plan, escalated decisions, and risks.
    ...
    data: [
      {
        moduleId: m6_3.id,
        type: 'MULTIPLE_CHOICE',
        question: 'The Consult For Africa24-week Turnaround Programme is divided into four phases. What is the correct sequence?',
        options: JSON.stringify([
      ...
      },
      {
        moduleId: m6_3.id,
        type: 'MULTIPLE_CHOICE',
        question: 'Which of the following is one of Consult For Africa\'s five anchor metrics for tracking turnaround progress?',
        options: JSON.stringify([
      ...
      },
      {
        moduleId: m6_3.id,
        type: 'MULTIPLE_CHOICE',
        question: 'Consult For Africa\'s benchmark for turnaround success at Week 24 is that what percentage of anchor metrics should hit their targets?',
        options: JSON.stringify([
        ...
        explanation: 'Consult For Africa\'s benchmark is 80% of anchor metrics hitting target by programme completion (4 out of 5). Hospitals achieving this threshold have a 90% probability of sustaining performance at 12 months post-engagement.',
        points: 1,
        order: 5,
      },
    ],
  ...
  console.log('  Module 6.3: Consult For AfricaTurnaround Programme - 5 questions')
    ...
    data: [
      {
        moduleId: m7_1.id,
        type: 'MULTIPLE_CHOICE',
        question: 'How many pillars does the Consult For Africa clinical governance framework include?',
        options: JSON.stringify([
        ...
        sections: [
          ...
          },
          {
            ...
            body: `Both JCI and SafeCare emphasise the six International Patient Safety Goals, which are non-negotiable requirements. IPSG 1: Identify patients correctly using at least two identifiers (name and date of birth, never bed number). IPSG 2: Improve effective communication, including read-back of verbal orders and critical test results. IPSG 3: Improve the safety of high-alert medications through standardised storage, labelling, and double-checking protocols. IPSG 4: Ensure safe surgery through the WHO Surgical Safety Checklist (time-out before incision). IPSG 5: Reduce healthcare-associated infections through hand hygiene and evidence-based precautions. IPSG 6: Reduce patient harm from falls through risk assessment and prevention protocols.
              ...
              For Consult For Africa consultants preparing hospitals for accreditation, the IPSGs are the starting point. They address the most common causes of preventable patient harm and are heavily weighted in survey scoring. A hospital that nails IPSGs demonstrates a foundational safety culture.`
          },
          {
            title: 'Accreditation Preparation Roadmap',
            type: 'text',
            body: `Consult For Africa uses a phased approach to accreditation readiness. Phase 1 (Months 1-3): Baseline Assessment. Conduct a mock survey against the relevant standard set (JCI or SafeCare), scoring every measurable element. This produces a gap analysis showing the distance between current state and accreditation requirements. Most African hospitals score 30-50% on initial baseline against JCI standards.
        ...
        sections: [
          ...
          },
          {
            ...
            body: `Patient safety systems depend on information flow. If staff do not report near-misses and adverse events, the organisation cannot learn. Most African hospitals have incident reporting rates far below international benchmarks, not because fewer incidents occur, but because staff fear punishment. Building a reporting culture requires three elements: a simple reporting mechanism (one-page form or digital tool, anonymous option available), a visible response loop (staff must see that their reports lead to action, not filing cabinets), and explicit protection from blame for honest reporting.
              ...
              Consult For Africa recommends a "just culture" framework that distinguishes between human error (system-supported, no blame), at-risk behaviour (coaching and system redesign), and reckless behaviour (accountability and discipline). This framework gives staff clarity on when reporting is safe and when behaviour crosses the line. Hospitals that implement just culture typically see reporting rates increase 5-10x within six months, which paradoxically looks like safety is getting worse when in fact visibility is improving.`
          }
        ],
        exercises: [
          {
  ...
  await prisma.trainingQuestion.createMany({
    data: [
      ...
      },
      {
        moduleId: m8_1.id,
        type: 'MULTIPLE_CHOICE',
        question: 'Consult For Africa approaches patient access as a:',
        options: JSON.stringify([
        ...
        explanation: 'Consult For Africa reframes patient access as a revenue function because registration accuracy directly determines downstream revenue capture. This reframing changes how staff are trained, how processes are designed, and how performance is measured.',
        points: 1,
        order: 4,
      },
      {
  ...
  await prisma.trainingQuestion.createMany({
    data: [
      ...
      },
      {
        moduleId: m8_2.id,
        type: 'MULTIPLE_CHOICE',
        question: 'Consult For Africa\'s charge capture audit typically reveals a revenue leakage rate of what percentage in most African hospitals?',
        options: JSON.stringify([
  ...
  await prisma.trainingQuestion.createMany({
    data: [
      ...
      },
      {
        moduleId: m8_3.id,
        type: 'MULTIPLE_CHOICE',
        question: 'Consult For Africa recommends that billing staff should be:',
        options: JSON.stringify([
        ...
        explanation: 'Consult For Africa recommends payer-specific standard operating procedures and dedicated billing staff trained on each payer\'s unique requirements (NHIS, HMOs, corporate schemes). Generalist billers are more likely to miss payer-specific documentation requirements.',
        points: 1,
        order: 3,
      },
      {
        moduleId: m8_3.id,
        type: 'MULTIPLE_CHOICE',
        question: 'In the Consult For Africa tiered collections strategy, what action is recommended at Tier 2 (31-60 days) for patient balances?',
        options: JSON.stringify([
      ...
      },
      {
        moduleId: m8_3.id,
        type: 'MULTIPLE_CHOICE',
        question: 'The third step in Consult For Africa\'s closed-loop denial management process is:',
        options: JSON.stringify([
  ...
  console.log('Consult For AfricaTraining Academy Specialist Level A seeding complete!')
