...
import { UPLOAD_SECTIONS } from "@/lib/dennis-ashley-audit";
...
export default function DocumentUploader() {
  ...
  async function sendOne(row: Row) {
    ...
    try {
      const presign = await fetch("/api/dennis-ashley-audit/upload", {
        method: "POST",
      ...
      const record = await fetch("/api/dennis-ashley-audit/upload", {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
