  ...
  CONSULTANT_MASTER: [
    {
      ...
      subsections: [
        { label: "a", text: "Client Data & Business Information - operational data, patient records, strategic plans, financial records, and organisational structures of C4A clients." },
        { label: "b", text: "C4A Methodologies, Frameworks & IP - proprietary consulting tools, assessment frameworks, analytical models, standard operating procedures, templates, and any other intellectual property developed or owned by Consult For Africa." },
      ...
      footer: `Confidential Information does not include information that: (i) is or becomes publicly known through no breach of this Agreement; (ii) was rightfully known to the Consultant before engagement with C4A; (iii) is independently developed by the Consultant without use of Confidential Information; or (iv) is required to be disclosed by law or court order, provided the Consultant gives prompt written notice where legally permissible.`,
    },
    {
      number: "2",
      ...
      subsections: [
        ...
        { label: "iii", text: "Not disclose Confidential Information to any third party, including other consultants not assigned to the same engagement, without prior written consent from C4A." },
        { label: "iv", text: "Promptly notify C4A upon becoming aware of any actual or suspected unauthorised disclosure or use of Confidential Information." },
        { label: "v", text: "Not retain copies of Confidential Information beyond the duration of each engagement, except as directed by C4A." },
      ],
    },
    {
      number: "3",
      title: "Duration",
      body: "This Agreement is effective from the date of execution and remains in force for the duration of the Consultant's engagement with C4A and for a period of three (3) years following the last engagement. Obligations with respect to trade secrets shall continue for as long as the information remains a trade secret under applicable law.",
    },
    {
      number: "4",
      title: "Intellectual Property",
      body: "All work product, deliverables, and intellectual property created by the Consultant in the course of C4A engagements shall be the property of Consult For Africa unless otherwise agreed in writing. The Consultant retains no rights to use C4A methodologies, frameworks, or client data for personal or third-party purposes.",
    },
    {
      number: "5",
      title: "Return of Materials",
      body: "Upon termination of each engagement or upon request by C4A, the Consultant shall promptly return or destroy all Confidential Information, work products, and materials in their possession and certify in writing that they have done so.",
    },
    {
      number: "6",
      title: "Non-Solicitation",
      body: "For a period of twelve (12) months following the last engagement with C4A, the Consultant shall not directly or indirectly solicit any C4A client for competing services, or recruit any C4A employee or fellow consultant, without prior written consent from C4A.",
    },
    {
      number: "7",
      title: "Remedies",
      body: "The Consultant acknowledges that any breach of this Agreement may cause irreparable harm to C4A and its clients. C4A shall be entitled to seek equitable relief, including injunction and specific performance, in addition to all other remedies available at law or in equity.",
    },
    {
      number: "8",
      title: "General Provisions",
