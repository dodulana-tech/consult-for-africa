...
export const metadata: Metadata = {
  ...
  description: "CFA strengthens clinical governance structures and prepares healthcare institutions for JCI, COHSASA, and SafeCare accreditation across Africa.",
