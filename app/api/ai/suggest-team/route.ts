...
export async function POST(req: NextRequest) {
  ...
  const prompt = `You are Nuru, CFA's internal intelligence system. An Engagement Manager needs you to analyze a project and suggest the complete team composition.
...
CFA operates as embedded execution teams inside hospitals. Teams are lean (2-5 people) and every person must be useful. Consider:
