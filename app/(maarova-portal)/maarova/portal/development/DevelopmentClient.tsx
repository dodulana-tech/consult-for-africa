    ...
    <div className="p-6 lg:p-10 max-w-6xl mx-auto space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-500 mt-1">
          Track your coaching journey and development goals, {userName.split(" ")[0]}.
        </p>
      </div>

      {/* Coaching Status Section */}
          ...
          {!coachingMatch ? (
            <div className="text-center py-10">
              <div
                ...
                style={{ backgroundColor: "#D4A574" + "20" }}
              >
                <svg
                  className="w-7 h-7"
                  style={{ color: "#D4A574" }}
              ...
              <h3 className="text-lg font-semibold mb-2" style={{ color: "#0F2744" }}>
                No coaching match yet
              </h3>
              <p className="text-gray-500 max-w-md mx-auto">
                {hasReport
                  ? "Your assessment is complete. Coaching matching is in progress and you will be notified once a coach has been assigned."
                  : "Complete your assessment to be matched with a coach tailored to your development needs."}
              </p>
            </div>
          ) : isPending ? (
            <div className="text-center py-10">
              <div className="animate-pulse flex flex-col items-center">
                ...
                <h3 className="text-lg font-semibold mb-2" style={{ color: "#0F2744" }}>
                  Coaching matching in progress
                </h3>
                <p className="text-gray-500 max-w-md">
                  We are finding the best coach for your profile and development needs. You will be notified once matched.
                </p>
              </div>
            </div>
          ) : (
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-5">
                ...
                >
                  {coachingMatch.coach.avatarUrl ? (
                    <img
                      src={coachingMatch.coach.avatarUrl}
                      alt={coachingMatch.coach.name}
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 flex-wrap">
                    <h3 className="text-lg font-semibold" style={{ color: "#0F2744" }}>
                      {coachingMatch.coach.name}
                    </h3>
                    <span
                      className={`text-xs font-medium ${
                        COACHING_STATUS[coachingMatch.status]?.color ?? "text-gray-500"
                      }`}
                    >
                      {COACHING_STATUS[coachingMatch.status]?.label ?? coachingMatch.status}
                    </span>
                  </div>
                  <p className="text-gray-600 text-sm">{coachingMatch.coach.title}</p>
                  <p className="text-gray-500 text-sm mt-1">
                    {coachingMatch.coach.city
                      ? `${coachingMatch.coach.city}, ${coachingMatch.coach.country}`
                      : coachingMatch.coach.country}{" "}
                    &middot; {coachingMatch.coach.yearsExperience} years experience
                  </p>
                  <p className="text-gray-600 text-sm mt-3 leading-relaxed">
                    {coachingMatch.coach.bio}
                  </p>
                  {coachingMatch.coach.certifications.length > 0 && (
                    <div className="flex flex-wrap gap-2 mt-3">
                      {coachingMatch.coach.certifications.map((c) => (
                        <span
                          key={c}
                  ...
                  {coachingMatch.coach.specialisms.length > 0 && (
                    <div className="flex flex-wrap gap-2 mt-2">
                      {coachingMatch.coach.specialisms.map((s) => (
                        <span
                          key={s}
                          className="text-xs px-2.5 py-1 rounded-full font-medium"
                          style={{
                            backgroundColor: "#D4A574" + "15",
                            color: "#9a7350",
                          }}
                        >
                          {s}
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <div className="bg-gray-50 rounded-lg p-4 text-center">
                  <p className="text-2xl font-bold" style={{ color: "#0F2744" }}>
                    {coachingMatch.sessionsScheduled}
                  </p>
                  <p className="text-xs text-gray-500 mt-1">Scheduled</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4 text-center">
                  <p className="text-sm font-semibold" style={{ color: "#0F2744" }}>
                    {formatDate(coachingMatch.nextSessionAt)}
                  </p>
                  <p className="text-xs text-gray-500 mt-1">Next session</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4 text-center">
                  <p className="text-sm font-semibold" style={{ color: "#0F2744" }}>
                    {coachingMatch.programme.replace(/_/g, " ")}
                  </p>
                  <p className="text-xs text-gray-500 mt-1">Programme</p>
                </div>
              </div>
            </div>
          )}
