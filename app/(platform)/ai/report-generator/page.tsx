  ...
  return (
    <div className="flex flex-col flex-1 overflow-hidden">
      <TopBar
        ...
        subtitle="Nuru-assisted consulting reports"
        backHref="/ai"
      />
      <main className="flex-1 overflow-y-auto p-6">
        <div className="max-w-2xl space-y-5">
          ...
          >
            ...
            <div>
              <p className="text-sm font-semibold text-gray-900">Report Generation with Nuru</p>
              <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">
                Turn your findings into a polished consulting report in 30 seconds. Enter your raw notes and recommendations, and Nuru structures them into an executive-ready document with Nigerian healthcare context, implementation roadmap, and severity-rated findings.
              </p>
            </div>
          </div>
